  ...
  const handlePrint = () => {
    if (payslipRef.current) {
      ...
      if (printWindow) {
        ...
        printWindow.document.write('<div class="p-6 max-w-xl mx-auto border border-gray-300 shadow-lg">');
    ...
    <div className="space-y-4">
      ...
      <Card ref={payslipRef} className="p-6">
        <CardHeader className="p-0 mb-4">
          <CardTitle className="text-2xl font-bold text-center">Payslip</CardTitle>
        ...
        <div className="grid grid-cols-2 gap-y-1 text-sm mb-4">
          ...
          <p className="text-right">{staff.first_name} {staff.last_name}</p>
